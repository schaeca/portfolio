import portraitCutout from "../assets/portrait-cutout.webp";
      ...
      <div className="page-container py-12">
        <div className="grid items-center gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:gap-14">
          ...
          <div className="relative z-20">
            <p className="mb-3 font-serif text-[clamp(1.4rem,7vw,2.25rem)] italic text-accent">
              Understand the problem.
            </p>

            <h1 className="text-[clamp(3.2rem,15vw,5.5rem)] leading-[0.84] font-extrabold tracking-[-0.065em] lg:text-[clamp(5rem,8vw,8rem)]">
              BUILD THE
            ...
            {/* POSITIONING */}
            <div className="mt-7 flex flex-wrap items-center gap-x-3 gap-y-3 text-sm font-semibold md:mt-8 md:gap-x-4">
...
function CutoutPortrait() {
  return (
    <div className="relative mx-auto mt-2 h-107.5 w-full max-w-107.5 md:h-135 md:max-w-130 lg:mt-0 lg:h-155 lg:max-w-none">
      {/* circle */}
      ...
      <div
        aria-hidden="true"
        className="dot-pattern absolute right-[3%] top-[12%] h-24 w-24 opacity-50 md:h-32 md:w-32 lg:right-0"
      />
